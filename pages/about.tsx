    ...
    <article className="personal">
      ...
      <div className="right">
        <div className="wrapper">
          ...
          <p>
            I’m a 30 year old designer and developer from Venezuela living in
            Madrid. Designing is my biggest passion, I like to create
            experiences that make people’s lives more enjoyable and easy.
          </p>

          <p>
            I have to admit that after years of turning design into code, I fell
            in love with it and it’s kind of an escape when I’m lacking
            creativity or need a break from design (we all know that happens),
            because I think it’s very satisfying when you make a code so clean
            and everything works perfectly.
          </p>

          <p>
            I focus on UX / UI, front development, branding, editorial and
            package design, I also love to travel, decorating everything, eat
            and make some lettering on my free hours (yes, they exist
            sometimes).
          </p>
          ...
          <p>
            I like to say that I am very organised and structured when it comes
